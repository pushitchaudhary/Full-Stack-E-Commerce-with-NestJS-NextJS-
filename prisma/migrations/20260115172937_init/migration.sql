...
-- CreateIndex
CREATE INDEX "order_items_ordersId_idx" ON "order_items"("ordersId");
...
-- AddForeignKey
ALTER TABLE "order_items" ADD CONSTRAINT "order_items_ordersId_fkey" FOREIGN KEY ("ordersId") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE CASCADE;
